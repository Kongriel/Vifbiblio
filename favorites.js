...
function cardHTML(v) {
  return `
    <a style="color:white; margin-bottom:1.3rem; text-decoration: none;" href="slug.html?id=${v.id}">
      <div class="card">
      <div class="title" style="margin:.5rem 0;font-weight:700; text-align: center; padding-bottom:1rem;">${v.title}</div>
        <img class="thumb" src="${thumbSrc(v)}" alt="${v.title}">

        <div class="desc" style="color:#aaa;font-size:.9rem; padding-top:1rem; padding-bottom:1rem;">${v.description || ""}</div>
