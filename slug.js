  ...
  items.forEach((v) => {
    ...
    a.innerHTML = `
      <div class="card" style="padding:12px;">
        <h3 style="color:white; text-align:center; padding-bottom: 1rem; margin:8px 0 4px;font-size:1rem">${v.title}</h3>
        <img style="width:100%;border-radius:8px" src="${thumb}" alt="${v.title}">
        <p style="color:#aaa; text-align:center; font-size:.9rem">${v.description || ""}</p>
        <div style="display:flex;gap:.4rem;justify-content:center;flex-wrap:wrap;margin-top:.35rem;">
